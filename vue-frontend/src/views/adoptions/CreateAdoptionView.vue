<template>
  <div class="page">
    ...
    <div v-if="isAuthenticated" class="form">
      ...
      <label class="form-element">
        <span class="form-element-description">Breed</span>
        <input v-model="breed" />
      </label>
      <label class="form-element">
        <span class="form-element-description">Age</span>
        <input v-model="age" />
      </label>
      <label class="form-element">
        <span class="form-element-description">Gender</span>
      ...
      <label class="form-element">
        <button @click="createAdoption()">Create</button>
      </label>
    </div>
